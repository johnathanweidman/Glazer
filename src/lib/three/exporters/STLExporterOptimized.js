...
import { Geometry, Matrix3, Vector3 } from '../three.module.js';
...
STLExporterOptimized.prototype = {
	...
	parse: (function () {
		...
		return function parse(object) {
			...
			output.setUint32(offset, numTriangles, true);
			offset += 4;
			...
			for (var i = 0, il = indices.length; i < il; i += 3) {
				...
				// Vertices
				output.setFloat32(offset, p1.x, true);
				offset += 4;
				output.setFloat32(offset, p1.y, true);
				offset += 4;
				output.setFloat32(offset, p1.z, true);
				offset += 4;

				output.setFloat32(offset, p2.x, true);
				offset += 4;
				output.setFloat32(offset, p2.y, true);
				offset += 4;
				output.setFloat32(offset, p2.z, true);
				offset += 4;

				output.setFloat32(offset, p3.x, true);
				offset += 4;
				output.setFloat32(offset, p3.y, true);
				offset += 4;
				output.setFloat32(offset, p3.z, true);
				offset += 4;
