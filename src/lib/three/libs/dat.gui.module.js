...
var BooleanController = (function (_Controller) {
	...
	function BooleanController(object, property) {
		...
		var _this2 = possibleConstructorReturn(
			this,
			(BooleanController.__proto__ || Object.getPrototypeOf(BooleanController)).call(
				this,
				object,
				property
			)
...
var OptionController = (function (_Controller) {
	...
	function OptionController(object, property, opts) {
		...
		var _this2 = possibleConstructorReturn(
			this,
			(OptionController.__proto__ || Object.getPrototypeOf(OptionController)).call(
				this,
				object,
				property
			)
...
var StringController = (function (_Controller) {
	...
	function StringController(object, property) {
		...
		var _this2 = possibleConstructorReturn(
			this,
			(StringController.__proto__ || Object.getPrototypeOf(StringController)).call(
				this,
				object,
				property
			)
...
var NumberController = (function (_Controller) {
	...
	function NumberController(object, property, params) {
		...
		var _this = possibleConstructorReturn(
			this,
			(NumberController.__proto__ || Object.getPrototypeOf(NumberController)).call(
				this,
				object,
				property
			)
		...
		if (Common.isUndefined(_this.__step)) {
			if (_this.initialValue === 0) {
				...
				_this.__impliedStep =
					Math.pow(10, Math.floor(Math.log(Math.abs(_this.initialValue)) / Math.LN10)) / 10;
			}
		} else {
...
var FunctionController = (function (_Controller) {
	...
	function FunctionController(object, property, text) {
		...
		var _this2 = possibleConstructorReturn(
			this,
			(FunctionController.__proto__ || Object.getPrototypeOf(FunctionController)).call(
				this,
				object,
				property
			)
...
var ColorController = (function (_Controller) {
	...
	function ColorController(object, property) {
		...
		var _this2 = possibleConstructorReturn(
			this,
			(ColorController.__proto__ || Object.getPrototypeOf(ColorController)).call(
				this,
				object,
				property
			)
...
function linearGradient(elem, x, a, b) {
	...
	Common.each(vendors, function (vendor) {
		elem.style.cssText +=
			'background: ' + vendor + 'linear-gradient(' + x + ', ' + a + ' 0%, ' + b + ' 100%); ';
	});
}
